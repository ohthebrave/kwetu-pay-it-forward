  ...
  return (
    <div className="">
      ...
      <div className="card ms-5">
        <div className="card-body">
            <img src={bull} alt="car" />
            <h5 className="card-title ms-5 me-5">RUTH MUTHEU  MUIA</h5>
            <p className="card-text">
